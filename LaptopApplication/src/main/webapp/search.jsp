...
<input type="text" name="search name" placeholder="enter details">
...
String search_laptop=request.getParameter("search_laptop");
PreparedStatement ps=connection.prepareStatement("select * from addlaptop where companyname like '"+search_laptop+"%'");
